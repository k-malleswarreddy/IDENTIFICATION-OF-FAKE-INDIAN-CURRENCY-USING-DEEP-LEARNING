...
# Custom layer for unknown layers during model loading
...
with custom_object_scope({'Cast': CastLayer}):
    model = load_model(r"C:\Users\K MALLESWAR REDDY\Music\FAKE_INDIAN_CURRENCY\FRONTEND\model.h5", safe_mode=False)
